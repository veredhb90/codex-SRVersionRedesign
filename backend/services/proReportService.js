...
const combineProAnalysis = (symbol, technical, newsAnalysis, generatedAt = new Date(), communitySentiment = null) => {
  ...
  return {
    ...
    latestSecFiling: news.latestSecFiling || null,
    latestMaterialEvent: news.latestMaterialEvent || null,
    companyReportsRetrievedAt: news.companyReportsRetrievedAt || null,
